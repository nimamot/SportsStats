...
/*-----------------------------------------------------------*/
    ...
    <div class="bavbarMain">
        <div class="title">
            <h1> <a href="hello.php">CPSC 304 SPORTS DATABASE : Hockey</a> </h1>
            
        </div>

        <div class="navbar">
            <h2 href="#PLAYERS">
                <form method="GET" action="hockey.php">
                    <input type="hidden" id="getAllPlayersRequest" name="getAllPlayersRequest">
                    <input type="submit" name="getAllPlayers" value="PLAYERS" >
                    <input type="hidden" name="sportName" value="Hockey" >
                </form>
            </h2>
                ...
                <h3 href="#">NHL</h3>
                  <ul class='submenu'>  
                    ...
                    <form method="GET" action="hockey.php">
                        ...
                        <input type="hidden" name="leagueName" value="NHL" >
                    </form>
                    </h2>
	...
	// A better coding practice is to have one method that reroutes your requests accordingly. It will make it easier to add/remove functionality.
        ...
        function handleGetTeamsRequest(){
            ...
            $result = executePlainSQL("SELECT * FROM Teams WHERE Teams.leaguename='NHL'");
            ...
            while(true){
                if (($row = oci_fetch_array($result)) != false) {
                    ...
                    echo "<div class='team_object' style='" . $team_object_style . "' >  <img src='". $row[3] ."' width='90'> 
                     <a href=hockey.php?getTeamInfoRequest=&getTeamInfo=" . $team_name_underscore."
        ...
        function handleGetTeamPlayersRequest($teamName){
            ...
            while(true){
                if (($row = oci_fetch_array($result)) != false){
                    ...
                    echo "<a href=hockey.php?getPlayerStatsRequest=&getPlayerStats=". $key ." style='font-size: 15px; margin: 0px; ' > MORE INFO </a>";
                    echo "</ul>";
                    echo "</div>";
                }else break;
            }
        ...
        function handleGetTeamInfoRequest($teamName){
            ...
            if (($row = oci_fetch_array($result)) != false){
                ...
                echo "<a href=hockey.php?getLeagueRequest=&getLeague=". $row[2] . " 
                style='font-size:25px; text-decoration:none; margin: 50px;'>  League: " .  $row[2] ." </a>";
                
                echo "<a href=hockey.php?getTeamPlayersRequest=&getTeamPlayers=". $teamName . " 
            ...
            // echo "<a href=hockey.php?getTeamStatsRequest=&getTeamStats=" . $teamName ." >  STATISTICS </a>";
        ...
        function handleGetAllPlayersRequest(){
            ...
            while(true){
                if (($row = oci_fetch_array($result)) != false){    
                    ...
                    echo "<h3> <a href=hockey.php?getPlayerStatsRequest=&getPlayerStats=". $key .">" . $row[1]. "</a> </h3>";
     ...
     function handlGetLeagueRequest($season, $leagueName){
            ...
            echo "<h2><a href=hockey.php?getTeamsRequest=&getTeams=TEAMS&leagues=$leagueName> Teams </a><hr /></h2>";
            echo "<h2> MATCHES </h2>";
            ...
            while(true){
                if (($row = oci_fetch_array($matches)) != false){  
                    ...
                    if(($playRow = oci_fetch_array($play)) != false){
                        ...
                        echo "<h3> Home Team: <a href=hockey.php?getTeamInfoRequest=&getTeamInfo=". preg_replace('/\s+/', '_', $playRow[3]) .">".$playRow[3] . 
                        "</a> <br> Away Team: <a href=hockey.php?getTeamInfoRequest=&getTeamInfo=". preg_replace('/\s+/', '_', $playRow[2]) .">".$playRow[2] . "</a></h3>";
